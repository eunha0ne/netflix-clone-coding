...
- [Read: customize-cra](https://github.com/arackaf/customize-cra)
- [Read: react-app-rewired](https://github.com/timarney/react-app-rewired)
...
- [Link: 리덕스](https://redux.js.org/introduction/getting-started)
- [Read: 리덕스, 스타일 가이드](https://redux.js.org/style-guide/style-guide)
- [Link: 리엑트 리덕스 (Offical React bindings for Redux)](https://react-redux.js.org/)
- [Link: Redux Thunk, 리덕스 미들웨어](https://github.com/reduxjs/redux-thunk)
- [Read: Redux Thunk 소개](http://react.vlpt.us/redux-middleware/04-redux-thunk.html)
- [Link: Redux Toolkit: 리덕스 툴킷](https://redux-toolkit.js.org/)
  - [Read: rtk-convert-todos-example](https://github.com/reduxjs/rtk-convert-todos-example)
  - [Read: redux-react-guide (with Redux Toolkit)](https://www.taniarascia.com/redux-react-guide/)
  - [Read: redux-made-easy-with-redux-toolkit-and-typescrip](https://www.mattbutton.com/redux-made-easy-with-redux-toolkit-and-typescript/)
- [Link 리덕스 데브툴: Redux-devtools-extension](https://github.com/zalmoxisus/redux-devtools-extension)

## 타입스크립트

- [Read: 타입스크립 참고](https://jeonghwan-kim.github.io/dev/2019/07/15/react-redux-ts.html)
- [Read: 타입스크립 참고](https://infoscis.github.io/2017/06/19/TypeScript-handbook-advanced-types/)
